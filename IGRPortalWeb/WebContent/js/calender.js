...
function calendar()
{
        ...
        beg_j = beg_j.getDay();
        document.write('<table cellspacing="0" cellpadding="0" class="cal_calendar" onload="opacity(document.getElementById(\'cal_body\'),20);"><tbody id="cal_body"><tr><th colspan="7">'+date_today+'</th></tr>');

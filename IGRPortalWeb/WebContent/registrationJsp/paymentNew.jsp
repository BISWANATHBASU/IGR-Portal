...
<table class="appFormBlock" align="center" cellspacing="2px"
	...
	<tr><td class="tdLabel"><!--:property value="getText('global.registration_fee_type')" /--शुल्क भुगतान का माध्यम:</td>
						...
						<!-- ,'SBI_MOPS':'Online Payment' --><!-- ,'SBI_MOPS':'Online' 'Paid_at_Office':'Cash',Registration,'e_Challan':'e-Challan' --
						<s:select headerKey="-1" headerValue="Fee Type" list="#{'Paid_at_Office':'Cash'}" 
						...
						<td class="field">
						<!-- 'stampPayment':'Stamp Fee', --
						<s:select headerKey="-1" headerValue="Select" list="#{'registrationFee':'Registration Fee'}" 
		...
		<div align="center">
			...
			<table class="appFormBlock" align="center" cellspacing="2px" cellpadding="1px">
				...
				<tr>
					<th colspan="4" class="field">नोट :- अगर आपका  देय मुद्रांक और पंजीयन शुल्क 0.0 आ रहा है या आप पंजीयन शुल्क पंजीयन कार्यालय में जमा करना चाहते हैं तो आप अप्पोइमेंट आप्शन को चुनें!</th>
				</tr>
				...
				<tr>
					...
					<th class="field">
						...
						<s:select headerKey="-1" headerValue="Select" list="#{'e_Challan':'e-Challan','e_stamp':'e-Stamp','treasury_stamp':'Treasury Stamp','bank':'SBI ePay'}" 
				...
				<tr>
					...
					<th class="field">
						...
						<s:select headerKey="-1" headerValue="Select" list="#{'Paid_at_Office':'Cash','e_Challan':'e-Challan','POS':'POS Machine','bank':'SBI ePay'}" 

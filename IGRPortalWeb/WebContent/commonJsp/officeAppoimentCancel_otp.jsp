	...
	<body>
		...
		<div class="main">
			<div class="container_12">
				...
				<form action="cancelAppointmentNo" validate="true" namespace="/" method="post" autocomplete="off">
					<div style="margin-top:0.5em;margin-left:2%;width:96%;border:1px solid black;">
						<div align="center" style="margin-top:20px;">
							...
							<table border="1" style="color: black;">
								...
								<s:hidden id="appointmentNoFinal" name="appointmentNoFinal" />
								...
								<tr>
									<th colspan="2"><br />
										...
										<input type="submit" value="Cancel Appointment" id="verifyOTP" />
									</th>
								</tr>
							</table>
							<br /><br />

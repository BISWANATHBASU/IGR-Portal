	...
	<head>
	    ...
	    <script>
	    	...
	    	function validateForm(){
	    		//alert("");
	    		//var selectedData = $('input[type=radio][name=webSiteRating]');
	    		var selectedData = $('input[name=webSiteRating]:checked', '#myForm').val();
	    		//alert("selectedData="+selectedData);
	    		
	    		if(selectedData == "Need Improvement"){
	    			var e_registration_id = $("#e_registration_id").val();
	    			if(e_registration_id == null || e_registration_id == ""){
	    				alert("कृपया ई-पंजीयन आईडी दर्ज करें!");
	    				return false;
	    			}
	    			var dsr_location = $("#dsr_location").val();
	    			if(dsr_location == null || dsr_location == ""){
	    				alert("कृपया कार्यालय का नाम चुनें !");
	    				return false;
	    			}
	    			var complain_detail = $("#complain_detail").val();
	    			if(complain_detail == null || complain_detail == ""){
	    				alert("कृपया किस प्रकार की समस्या चुनें !");
	    				return false;
	    			}//sub_complain_detail//
	    			return true;
	    		}
	    		else if(selectedData == "Excellent" || selectedData == "Average" || selectedData == "Satisfactory"){
	    			return true;
	    		}
	    		else{
    				alert("कृपया दरख्वास्त विस्तार चुनें !");
	    			return false;
	    		}
	    	}
	    </script>
...
<div class="main">
	...
	<form id="myForm" action="addFeedBackForm" validate="true" namespace="/" method="post" autocomplete="off" onsubmit="return validateForm();">
    <div style="margin-top:0.5em;margin-left:2%;width:96%;border:1px solid black;">
      <div align="center" style="margin-top:20px;">
			...
			<h2 style="color:blue;"><u>प्रतिक्रिया<!-- / शिकायत--> दर्ज करें</u></h2>
			...
			<table id="show_hide_2">
				<tr><th colspan="2"><font color="black">पंजीकरण सन्दर्भ विवरण</font><s:hidden name="feed_back_category" id="feed_back_category" value="Feed Back" theme="simple" title="Invalid email address" /> </th></tr>
				<tr>

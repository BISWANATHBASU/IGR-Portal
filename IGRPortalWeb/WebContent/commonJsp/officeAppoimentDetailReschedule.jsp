	    		...
	    		$("body").delegate("#appointmentDate","change",function(event){
		    		try{
					    ...
					    var options='';
					      ...
					      $.getJSON('fetchAppTimeRescheduleList.action', formInput,function(data) {
	...
	<body>
		...
		<div class="main">
			<div class="container_12">
				...
				<form action="updateAppointmentDetailReschedule" validate="true" namespace="/" method="post" autocomplete="off" onsubmit="return formValidation();">
					<div style="margin-top:0.5em;margin-left:2%;width:96%;border:1px solid black;">
						<div align="center" style="margin-top:20px;">
							...
							<br />
							<h2 style="color:blue;"><u><!-- संशोधन -->अपॉइंटमेंट पुनः निर्धारण<!-- हेतु --></u></h2>

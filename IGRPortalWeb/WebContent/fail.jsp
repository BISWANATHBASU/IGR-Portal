...
<html>
	...
	<body>
		<%
			...
			final Logger log = Logger.getLogger("fail.jsp");
	    	...
	    	String sql = "insert into sbi_response (slno,dept_tran_id,bank_tran_id,response_txt,tran_amount,tran_crancy,tran_type,tran_other,tran_response,tran_bank,tran_no,tran_date,tran_datetime)"
	    			+" values("+slno+",'"+dept_tran_id+"','"+bank_tran_id+"','"+response_txt+"','"+tran_amount+"','"+tran_crancy+"','"+tran_type+"','"+tran_other+"','"+tran_response+"','"+tran_bank+"','"+tran_no+"','"+tran_date+"','"+entryDateTime+"')";

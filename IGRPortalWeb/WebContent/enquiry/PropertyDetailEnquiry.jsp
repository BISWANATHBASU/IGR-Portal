...
<div class="main">
             ...
             <div class="wrapper">
               <article class="grid_12">
                   ...
                   <ol class="breadcrumb breadcrumb-arrow">
						...
						<li><a href="/IGRPortalWeb/reckonerSubAction.action">हमारे बारे में<!--à¤°à¥à¤¡à¥ à¤°à¥à¤à¥à¤¨à¤°--></a></li>
				...
				<tr>
					...
					<td class="tdfield"><s:select list="districtList" headerKey="" headerValue="Select" listKey="typeCode"
				...
				<tr>
						...
						<td>
						<div class="amount_show" id="min_val_col" ></div>
	...
	<tr><td align="center">
					...
					<!-- à¤ªà¤à¤à¥à¤¯à¤¨ à¤à¤¬ à¤®à¥à¤¦à¥à¤°à¤¾à¤à¤ à¤¶à¥à¤²à¥à¤ à¤¤à¤¦à¥à¤ªà¤°à¤¾à¤¨à¥à¤¤ -->
					</td>
					</tr>
					</table>
					</s:form>

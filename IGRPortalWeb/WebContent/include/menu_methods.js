...
function Go(){
	...
	BeforeStart();
	Creatd=0; Loadd=1;
//	status='Welcome to Peerless Integrated Information System';
	if(FrstCreat){
		...
		if(WebMasterCheck){	if(!Check('Menu',NoOffFirstLineMenus)){
...
//	status='Welcome to Peerless Integration Information System'
}

...
<html>
	<head>
		...
		<script>
			function abc(){
				var url = "TahasilWiseAction.action";
	...
	<body oncontextmenu="return false;">
		<%
			...
			int i = 0;
			String districtName = "";
			Logger log = Logger.getLogger("collectorJsp/districtWise.jsp");
			...
			try{
				...
				if (con != null) {
					...
					while (rs.next()) {
						...
						<tr class="field">
							<th colspan="5">जिला <%=districtName%></th>
						</tr>
						<tr class=tdLabel>
							<th>क्रम संख्या</th>
						...
						<tr <%=backColor%>>
							<td><%=i%></td><td><a href="TahasilWiseAction.action"><%=dataCount%></a></td>
							<!--td><%=i%></td><td><a href = "javascript:void(0)" onclick = "abc()"><%=dataCount%></a></td-->
							<!-- <a> -->
							<td></td>
							<td></td>
							<td></td>

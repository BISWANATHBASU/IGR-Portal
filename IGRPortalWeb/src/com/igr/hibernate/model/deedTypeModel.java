...
public class deedTypeModel implements Serializable {
	...
	private boolean considered_amount;
	private boolean cess_amount;
	...
	public boolean isConsidered_amount() {
		return considered_amount;
	}

	public void setConsidered_amount(boolean considered_amount) {
		this.considered_amount = considered_amount;
	}

	@Column(name = "cess_amount")
	public boolean isCess_amount() {
		return cess_amount;
	}

	public void setCess_amount(boolean cess_amount) {

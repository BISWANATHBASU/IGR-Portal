...
public class SessionTimeoutFilter implements Filter {
	...
	private static Logger log = Logger.getLogger(SessionTimeoutFilter.class);
	...
	public void init(FilterConfig config) throws ServletException {
		...
		log.fatal("Session Timeout filter");
		log.fatal("entryPoints:"+entryPoints);
		if (entryPoints != null) {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		log.fatal("Session Timeout filter's doFilter");
		HttpServletRequest req = (HttpServletRequest) request;
		HttpServletResponse res = (HttpServletResponse) response;
		log.fatal("Entryurls Value:"+entryURLs.size());
